...
- Reliability runner (current owned-group-absence gate at `9663431`): all 6 layers passed — 40 client unit files / 322 tests (14.26 s), 3 module unit files / 62 tests (223 ms), 19 script tests, typecheck, coverage, and module build. Timings are diagnostic only.
...
- Auditable final full gate (2026-08-30, `9663431`): core 21 passed/5 skipped (29.2 s), composite 1/1 (9.3 s; 12.0 s phase), publication 1/1 (4.0 s; ~6–7 s phase), sharing 1/1 (2.6 s), aggregate 24/8; Pages 2/2 in 1.4 s. `git diff --exit-code -- client/src/module_bindings` exited 0; 3000 and 4173 had no listeners after teardown.
