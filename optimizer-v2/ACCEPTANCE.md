...
- Reliability runner (current phase-isolation gate at `bec08b3`): all 6 layers passed — 40 client unit files / 322 tests (14.59 s), 3 module unit files / 62 tests (223 ms), 17 script tests, typecheck, coverage, and module build. Timings are diagnostic only.
...
- Auditable final full gate (2026-08-30, `bec08b3`): core 21 passed/5 skipped (29.5 s), composite 1/1 (12.9 s), publication 1/1 (7.0 s), sharing 1/1 (2.5 s), aggregate 24/8; Pages 2/2 in 1.5 s. `git diff --exit-code -- client/src/module_bindings` exited 0.
...
- Base failure runs: [Optimizer V2 CI](https://github.com/Literalman669/sbo-rebirth-planner/actions/runs/33299676885) and [Deploy Optimizer V2](https://github.com/Literalman669/sbo-rebirth-planner/actions/runs/33299676888) failed before authentication/publish because the ambient GitHub Actions base was applied to the local browser server. The repaired [CI rerun](https://github.com/Literalman669/sbo-rebirth-planner/actions/runs/33300415526) and [deploy rerun](https://github.com/Literalman669/sbo-rebirth-planner/actions/runs/33300415518) cleared direct-route/keyboard checks but hit 30-second outer watchdogs in two bounded desktop stress cases. The third [CI run](https://github.com/Literalman669/sbo-rebirth-planner/actions/runs/33300931793) and [deploy run](https://github.com/Literalman669/sbo-rebirth-planner/actions/runs/33300931706) proved those cases reach the exact 120-second and 60-second per-test limits in CI; every later sharing timeout cascaded from aborted cleanup. Production steps were skipped. Fourth reruns are pending the CI-watchdog commit.
- Base failure runs: [Optimizer V2 CI](https://github.com/Literalman669/sbo-rebirth-planner/actions/runs/33299676885) and [Deploy Optimizer V2](https://github.com/Literalman669/sbo-rebirth-planner/actions/runs/33299676888) failed before authentication/publish because the ambient GitHub Actions base was applied to the local browser server. The repaired [CI rerun](https://github.com/Literalman669/sbo-rebirth-planner/actions/runs/33300415526) and [deploy rerun](https://github.com/Literalman669/sbo-rebirth-planner/actions/runs/33300415518) cleared direct-route/keyboard checks. Third [CI](https://github.com/Literalman669/sbo-rebirth-planner/actions/runs/33300931793)/[deploy](https://github.com/Literalman669/sbo-rebirth-planner/actions/runs/33300931706) runs hit strict workload watchdogs; fourth [CI](https://github.com/Literalman669/sbo-rebirth-planner/actions/runs/33301520394)/[deploy](https://github.com/Literalman669/sbo-rebirth-planner/actions/runs/33301520388) runs proved the true fault was connection exhaustion before workload phases. Sharing failures cascaded and production steps were skipped. Fifth reruns are pending phase isolation.
