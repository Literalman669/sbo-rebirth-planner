...
- Reliability runner (current owned-process-group gate at `038d924`): all 6 layers passed — 40 client unit files / 322 tests (14.44 s), 3 module unit files / 62 tests (225 ms), 18 script tests, typecheck, coverage, and module build. Timings are diagnostic only.
...
- Auditable final full gate (2026-08-30, `038d924`): core 21 passed/5 skipped (30.0 s), composite 1/1 (12.2 s), publication 1/1 (6.8 s), sharing 1/1 (2.6 s), aggregate 24/8; Pages 2/2 in 1.4 s. `git diff --exit-code -- client/src/module_bindings` exited 0; 3000 and 4173 had no listeners after teardown.
