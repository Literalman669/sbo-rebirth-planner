...
import DeletePlannerDocReducer from "./delete_planner_doc_reducer";
import UpsertPlannerDocReducer from "./upsert_planner_doc_reducer";

// Import all procedure arg schemas

// Import all table schema definitions
import MyPlannerDocsRow from "./my_planner_docs_table";

/** Type-only namespace exports for generated type groups. */

/** The schema information for all tables in this module. This is defined the same was as the tables would have been defined in the server. */
const tablesSchema = __schema({
  my_planner_docs: __table({
...
const reducersSchema = __reducers(
  __reducerSchema("delete_planner_doc", DeletePlannerDocReducer),
  __reducerSchema("upsert_planner_doc", UpsertPlannerDocReducer),
);
